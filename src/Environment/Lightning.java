...
public class Lightning {
    ...
    public Lightning(GamePanel GamePanel, int circleSize){
        ...
        int centerX = CoreGame.GamePanel.truePlayerScreenX + (CoreGame.GamePanel.tileSize)/2;
        ...
        g2.fillRect(0, 0, CoreGame.GamePanel.screenWidth, CoreGame.GamePanel.screenHeight);
